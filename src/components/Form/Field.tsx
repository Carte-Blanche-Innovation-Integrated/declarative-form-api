...
import { FieldError as RACFieldError } from "@/components/Form/FieldError.tsx";
...
export function Label(props: LabelProps) {
  return (
    <RACLabel
      {...props}
      className={twMerge(
        "mb-1 block text-sm font-bold leading-relaxed text-gray-800",
        props.className,
      )}
    />
  );
...
export function FieldError({ className, ...props }: FieldErrorProps) {
  return (
    <RACFieldError {...props} className="contents">
